...
export default function SlideInLeft({ className, children, delay, customScreenSize }: SlideInLeftProps) {
  ...
  // Animation variant for slide-in from the left
  const slideInVariant = {
    initial: { opacity: 0, x: -100 },
    animate: { opacity: 1, x: 0 },
  };

  // If a custom screen size is provided, use "animate" immediately
